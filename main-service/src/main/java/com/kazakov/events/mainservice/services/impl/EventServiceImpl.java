...
import com.kazakov.events.mainservice.exceptions.*;
...
import com.kazakov.events.mainservice.dto.mappers.EventMapper;
...
public class EventServiceImpl implements EventService {
    ...
    public EventFullDto updateEvent(EventUpdateDto eventUpdateDto, Long userId, Long eventId) {
        ...
        if (eventUpdateDto.getStateAction() != null) {
            if (eventUpdateDto.getStateAction().equals(EventAction.PUBLISH_EVENT)
            ...
            } else if (eventUpdateDto.getStateAction().equals(EventAction.REJECT_EVENT)
                    && !event.getState().equals(EventState.PENDING)) {
                throw new EventUpdateDeniedException(
        ...
        copyProperties(eventUpdateDto, event, Utils.getNullPropertyNames(eventUpdateDto));
